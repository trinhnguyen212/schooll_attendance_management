...
DB_HOST=127.0.0.1
DB_PORT=3306
DB_DATABASE=school-attendance-app
DB_USERNAME=admin
...
Use any tool or cli like `mysqldump`, `mariadb-dump`. I already write a NodeJS wrapper base on `mysqldump` for better performance.
