                        ...
                        <thead>
                            <tr>
                                ...
                                {role === 'student' ?
                                    ...
                                    <th className={css(styles.column, styles.medium)}>{language?.header.thought}</th></>
                                    : role === 'teacher' ?
                                        <th className={css(styles.column, styles.medium)}>{language?.header.branch}</th>
                                        : null}
                                            ...
                                            >
                                                ...
                                                </td>
                                                {
                                                    role === 'student' ?
                                                        ...
                                                        </td> */}<td className={css(styles.column, styles.medium)}>
                                                                {user.schoolOfThought?.name}
                                                            </td></>
                                                        : role === 'teacher' ?
                                                            <td className={css(styles.column, styles.medium)}>
                                                                {user.branch?.name}
