                        ...
                        <div className={styles.groupInputs}>
                            <div className={styles.wrapItem}>
                                ...
                                <input
                                    ...
                                    defaultValue={queryData?.data?.user?.firstName.charAt(0).toUpperCase() + queryData?.data?.user?.firstName.slice(1)}
                            ...
                            <div className={styles.wrapItem}>
                                ...
                                <input
                                    id='last_name'
                                    disabled={disabledUpdate}
                                    defaultValue={queryData?.data?.user?.lastName.charAt(0).toUpperCase() + queryData?.data?.user?.lastName.slice(1)}
                            ...
                            {queryData.data?.user.role.name === 'student' ?
                                ...
                                <div className={styles.wrapItem}>
                                        <label className={appStyles.required} htmlFor='school_of_thought'>{language?.thought}</label>
                                        <input
                                            id='school_of_thought'
                                            disabled={disabledUpdate}
                                            defaultValue={queryData.data.user.schoolOfThought?.shortcode || ''}
                                            name='school_of_thought'
                                            className={css(appStyles.input, styles.inputItem)} />
                                    </div></>
                                : queryData.data?.user.role.name === 'teacher'
                                    ? <div className={styles.wrapItem}>
                                        <label className={appStyles.required} htmlFor='branch'>{language?.branch}</label>
                                        <input
                                            id='branch'
                                            disabled={disabledUpdate}
                                            defaultValue={queryData.data.user.branch?.shortcode || ''}
                                            name='branch'
                                            className={css(appStyles.input, styles.inputItem)}
                                        />
                                    </div> : null
