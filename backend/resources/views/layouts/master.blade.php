...
<head>
    ...
    <meta property="og:image" content="/madrasah-logo.png">
    <meta property="og:url" content="{{ config('app.url') }}">
    <meta property="og:type" content="website">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <link rel="shortcut icon" href="/madrasah-logo.png" type="image/x-icon">
...
<body>
    <header>
        <div>
            <a href="/">
                <img height="30" src="/madrasah-logo.png" alt="">
            </a>
